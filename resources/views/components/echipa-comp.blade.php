<div class="col col-lg-7">
   ...
   <table id="mesaje" style="width:100%" class="table table-bordered table-striped table-hover">
      ...
      <tr>
         ...
         <td>
            <button class='sterge_membru form-control' >Sterge</button>
         </td>
         <td>
         ...
         <td>
      <a href="{{  route('convocator',['id'=>$user->id]) }}"  id="" class="btn btn-primary trimite_email" data-bs-toggle="modal" data-bs-target="#convoacaModal" >
           Convoaca</a>  
   </td>
       @endforeach
   </table>
