...
<div class="modal fade" id="yesNoModal" tabindex="-1" aria-labelledby="yesNoModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" wire:click="resetUser">No</button>
        <button type="button" class="btn btn-primary" id="confirmYes" data-bs-dismiss="modal" wire:click="stergeUser()">Yes</button>
      </div>
    </div>
  </div>
</div>